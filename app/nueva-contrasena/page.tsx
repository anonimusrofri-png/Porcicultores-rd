    ...
    return (
      <div className="min-h-screen bg-slate-100 flex items-center justify-center p-4 font-sans">
        <div className="bg-white rounded-2xl p-8 max-w-md w-full text-center shadow-xl border border-slate-200">
          ...
          <h2 className="text-xl font-bold text-slate-900 mb-2">Contrase a actualizada</h2>
          <p className="text-slate-600 text-sm leading-relaxed mb-6">
            Tu contrase a fue actualizada exitosamente.
          </p>
          <Link
            href="/login"
    ...
    <div className="min-h-screen bg-slate-100 flex items-center justify-center p-4 font-sans">
      <div className="bg-white rounded-2xl p-8 max-w-md w-full shadow-xl border border-slate-200">
        <div className="text-center mb-6">
          ...
          <h1 className="text-xl font-bold text-slate-900">Nueva Contrase a</h1>
          <p className="text-slate-500 text-xs mt-1">Ingresa tu nueva contrase a de acceso</p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            />
            {confirmar && confirmar !== password && (
              <p className="text-red-500 text-xs mt-1 font-medium">Las contrase as no coinciden</p>
            )}
          </div>
